...
/**
 * Componente fondamentale che rappresenta il nodo di comunicazione MDTN.
 */
public class BundleNode {
	...
	/** Booleano che determina lo stato di aggiornamento delle risorse*/
	...
	public BundleNode(URI myEID){
		...
		//Threda che cerca di forzare Dalvik ad eseguire il garbaceCollector.
		...
		/* Eventulmente, questo thread può essere usato per resettare il sequenceNumber come suggerito
		 * dagli RFC.
	...
	/**
	 * Ritorna il log degli eventi.
	 * @return un vector contentente i log.
	 */
	...
	/**
	 * Ritorna la lista delle risorse remote.
	 * @return un vector di risorse.
	 */
	...
	/**
	 * Ritorna la lista delle risorse pubbliche.
	 * @return un vector di risorse.
	 */
	...
	/**
	 * Ritorna lo stato di aggiornamento delle risorse.
	...
	public class BPAgent {
		 ...
		 * @return un long che rappresenta la quatità di dati ricevuti.
		 */
		...
		/**
		 * Ritorna lo stato di terminazione del trasferimento.
		 * @return un booleano che indica se il trasferimento è finito.
		 */
		 ...
		 * @return un booleano che indica se la connessione è andata a buon fine.
		 */
		public boolean connectToService(String ip){

			//Richiama il ConvergenceLayer per effettuare realmente la connessione.
		...
		/**
		 * Ritorna l'ip corrente.
		 * @return una stringa contenente un indirizzo ip.
		 */
		public String getMyIp(){
			return myTcpConn.getIpAddress();
		}

		/** Effettua disconnessione dal servizio MDTN. */
